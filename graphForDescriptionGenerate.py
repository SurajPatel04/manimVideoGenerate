...
from descriptionGenerate import  generateDetailedDescription, validateDescription,refineDescription, router,generateMultipleDescription
...
graph_build.add_edge("generateMultipleDescription", "generateDetailedDescription")
